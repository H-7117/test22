          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between mt-2">
                ...
                <h5 class="card-title fs-3 " id="font">الوظائف</h5>
                <button class="create float-right"><a style="color: white" id="font">أضافه</a></button>
              </div>
              ...
              <div class="card col-lg-12 border">
                  <div class="container p-3 d-flex  justify-content-between">
                    <div class="d-flex">
                      <h5 class="mt-1 fw-bold text-primary" id="font">مطور واجهات</h5>
