          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between mt-2">
                ...
                <button class="create float-right"><a style="color: white" href="{{ route('platform.roles.add') }}">أضافه</a></button>
              </div>
              ...
              <table dir="rtl" id="listTable" class="table ">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <button class="btn"><a href="{{ route('platform.roles.view') }}"><i class="bi bi-eye"></i></a></button>
                      <button class="btn"><a href="{{ route('platform.roles.edit') }}"><i class="bi bi-pen"></i></a></button>
                      {{-- <button class="btn"><a href="{{ route('platform.roles.delete') }}"><i class="bi bi-trash"></i></a></button> --}}
