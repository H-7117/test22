          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between mt-2">
                ...
                <button class="create float-right"><a style="color: white" href="{{ route('seeker.add') }}">أضافه</a></button>
              </div>
              ...
              <table dir="rtl" id="listTable" class="table ">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <button class="btn"><a href="{{ route('seeker.view') }}"><i class="bi bi-eye"></i></a></button>
                      <button class="btn"><a href="{{ route('seeker.edit') }}"><i class="bi bi-pen"></i></a></button>
                      <button class="btn"><a href="{{ route('seeker.delete') }}"><i class="bi bi-trash"></i></a></button>
