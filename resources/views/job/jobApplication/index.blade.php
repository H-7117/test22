              ...
              <table dir="rtl" id="listTable" class="table ">
                ...
                <tbody>
                    <?php 
                        $counter =0;
                        ?>
                  @foreach ($jobApplcation as $jobApplcations)
                    
                  <tr>
                    <td>{{ $jobApplcations->job->Title }}</td>
                    ...
                    <td>
                       <button class="btn"><a href="{{ route('jobApplication.show',$jobApplcations->id) }}"><i class="bi bi-eye"></i></a></button>
                       <button class="btn"><a href="{{ route('jobApplication.edit',$jobApplcations->id) }}"><i class="bi bi-pen"></i></a></button>
