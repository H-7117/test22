          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between mt-2">
                ...
                <button class="create float-right"><a style="color: white" href="{{ route('job.add') }}">أضافه</a></button>
              </div>
              ...
              <table dir="rtl" id="listTable" class="table ">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <button class="btn"><a href="{{ route('job.view') }}"><i class="bi bi-eye"></i></a></button>
                      <button class="btn"><a href="{{ route('job.edit') }}"><i class="bi bi-pen"></i></a></button>
                      <button class="btn"><a href="{{ route('job.delete') }}"><i class="bi bi-trash"></i></a></button>
